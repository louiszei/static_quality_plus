...
namespace static_quality
{
    internal class static_quality_Config_Tab : MainTabWindow
    {
        ...
        public override void DoWindowContents(Rect canvas)
        {
            ...
            bool[] ss = new bool[4];
            listing_Standard.Label("SQP_Skill_options");
            listing_Standard.Gap(12f);
            ...
            listing_Standard.Gap(12f);
            string text_ls = "SQP_Daily_xp_cap_level_based";
            listing_Standard.CheckboxLabeled(text_ls, ref settings.learning_saturation_tweak, "SQP_Daily_xp_cap_level_based_Description");
            listing_Standard.Gap(24f);
            listing_Standard.Label("SQP_Passion_options");
            listing_Standard.Gap(12f);
            string text_pt = "SQP_Passion_tweak_enabled";
            listing_Standard.CheckboxLabeled(text_pt, ref settings.passion_tweak, "SQP_Passion_tweak_enabled_Description");
            //listing_Standard.Gap(12f);
            string text_pg = "SQP_Passion_gain_enabled";
            listing_Standard.CheckboxLabeled(text_pg, ref settings.passion_gain, "SQP_Passion_gain_enabled_Description");
            //listing_Standard.Gap(12f);
            string text_pc = "SQP_Passion_cap_enabled";
            listing_Standard.CheckboxLabeled(text_pc, ref settings.passion_cap, "SQP_Passion_cap_enabled_Description");
            listing_Standard.Gap(12f);
            listing_Standard.Label("SQP_Miscellanenous_options");
            listing_Standard.Gap(12f);
            string text_pr = "SQP_Plant_resting_enabled";
            listing_Standard.CheckboxLabeled(text_pr, ref settings.plant_rest, "SQP_Plant_resting_enabled_Description");
            listing_Standard.Gap(12f);
